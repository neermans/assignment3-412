...
urlpatterns = [
    ...
    path('profile/status/create_status/', CreateStatusMessageView.as_view(), name='create_status'),  # New URL for status messages
    path('profile/update', UpdateProfileView.as_view(), name='update_profile'), # New URL for updating profile
    ...
    path('profile/add_friend/<int:other_pk>', CreateFriendView.as_view(), name='add_friend'), # New URL for creating a friend 
    path('profile/friend_suggestions', ShowFriendSuggestionsView.as_view(), name='friend_suggestions'), # New URL for showing friend suggestions for a user
    path('profile/news_feed', ShowNewsFeedView.as_view(), name='news_feed'), # New URL for showing the news feed of a profile
